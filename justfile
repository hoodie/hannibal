...
test $RUST_LOG="trace" $STRESS_COUNT="3":
    @cargo -q nextest run --profile ci --workspace --all-targets --stress-count $STRESS_COUNT
    @cargo -q nextest run --profile ci --workspace --lib --no-default-features --features tokio_runtime --stress-count $STRESS_COUNT
    @cargo -q nextest run --profile ci --workspace --lib --no-default-features --features async_runtime --stress-count $STRESS_COUNT
    @cargo -q nextest run --profile ci --workspace --lib --no-default-features --features async_runtime,tokio --stress-count $STRESS_COUNT
