...
clippy:
    ...
    cargo --quiet clippy --workspace --quiet --lib --tests --no-default-features --features smol_runtime
...
test $NEXTEST_STATUS_LEVEL="slow":
    ...
    cargo nextest run --workspace --lib --no-default-features --features smol_runtime
