...
test $RUST_LOG="trace" $STRESS_COUNT="3":
    ...
    cargo nextest run --profile ci --workspace --lib --no-default-features --features tokio_runtime --stress-count $STRESS_COUNT
    cargo nextest run --profile ci --workspace --lib --no-default-features --features async_runtime --stress-count $STRESS_COUNT
    cargo nextest run --profile ci --workspace --lib --no-default-features --features async_runtime,tokio --stress-count $STRESS_COUNT

    cargo nextest run --profile ci --workspace --lib --no-default-features --features async_channel,tokio_runtime --stress-count $STRESS_COUNT
    cargo nextest run --profile ci --workspace --lib --no-default-features --features async_channel,async_runtime --stress-count $STRESS_COUNT
    cargo nextest run --profile ci --workspace --lib --no-default-features --features async_channel,async_runtime,tokio --stress-count $STRESS_COUNT
